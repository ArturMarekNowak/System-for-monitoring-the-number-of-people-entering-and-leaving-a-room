...
if mode[0] == "c":
    ...
    haar_upper_body_cascade = cv2.CascadeClassifier(r"data/haarcascade_upperbody.xml")
    ...
    while True:
        ...
        #frame = imutils.resize(frame, width=320) # resize original video for better viewing performance
